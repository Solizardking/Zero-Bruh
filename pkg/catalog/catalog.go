...
// BundledSkillsDir walks from the process working directory (and parents) for the
// go-bot skills pack (directory containing pack-index.json). Empty if not found.
